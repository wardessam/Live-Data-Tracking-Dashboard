...
namespace WEBAPI.Controllers
{
    ...
    [ApiController]
    public class ReportmController : ControllerBase
    {
        int AID = Branchcs.AID;
        private readonly IConfiguration _configuration;

        public ReportmController (IConfiguration configuration)
        {
        ...
        public JsonResult Get()
        {
            ...
            string query = "select Cost,Amount,Date from Total_Sales_Branch where MONTH(Date) = @curMonth and YEAR(Date) = @curYear and Branch_ID = @ActID";
