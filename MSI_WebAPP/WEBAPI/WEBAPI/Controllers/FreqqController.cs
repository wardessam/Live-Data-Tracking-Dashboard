...
namespace WEBAPI.Controllers
{
    ...
    [ApiController]
    public class FreqqController : ControllerBase
    {
        int AID = Branchcs.AID;
        private readonly IConfiguration _configuration;

        public FreqqController(IConfiguration configuration)
        {
        ...
        public JsonResult Get()
        {
            ...
            string query = "select Frequent_Item,Amount,Date from Frequent_Items where YEAR(Date) = @curYear and MONTH(Date) BETWEEN @quarter_start and @quarter_end and Branch_ID = @ActID";
