...
refreshlist() {
    fetch(process.env.REACT_APP_API+'Rec')
...
componentDidUpdate()
{
    ...
    RecommendationHeader = "Normal Recommendations"
        ...
        <div>
            ...
            <ol className="RecommendationList">
              ...
              <Fragment key ={rep.Freq} >
                  <li className="even" >The item(s) {rep.Freq} are recomended for season {rep.Seas} with 
