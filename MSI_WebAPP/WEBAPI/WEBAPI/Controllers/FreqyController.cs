...
namespace WEBAPI.Controllers
{
    ...
    [ApiController]
    public class FreqyController : ControllerBase
    {
        int AID = Branchcs.AID;
        private readonly IConfiguration _configuration;

        public FreqyController(IConfiguration configuration)
        {
        ...
        public JsonResult Get()
        {
            ...
            string query = "select Frequent_Item,Amount,Date from Frequent_Items where YEAR(Date) = @curYear and Branch_ID = @ActID";
