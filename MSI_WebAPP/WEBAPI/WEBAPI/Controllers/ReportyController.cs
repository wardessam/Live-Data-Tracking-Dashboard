...
namespace WEBAPI.Controllers
{
    ...
    [ApiController]
    public class ReportyController : ControllerBase
    {
        int AID = Branchcs.AID;
        private readonly IConfiguration _configuration;

        public ReportyController(IConfiguration configuration)
        {
        ...
        public JsonResult Get()
        {
            ...
            string query = "select Cost,Amount,Date from Total_Sales_Branch where YEAR(Date) = @curYear and Branch_ID = @ActID";
